...
class FirewallRetryView(discord.ui.View):
    ...
    async def retry_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        from commands.views.onboarding_embeds import _info_box, _COLOR_NEW
        ...
        try:
            ...
            if self.op == "q1_allow":
                ...
                try:
                    from commands.views.onboarding_embeds import _whitelist_question_embed
                ...
                if hostname.lower() != "unknown":
                    ...
                    session.step = "q3"
                    try:
                        from commands.views.onboarding_embeds import _name_question_embed
...
class RenameRetryView(discord.ui.View):
    ...
    async def keep_unknown_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        for c in self.children:
            c.disabled = True
        session = self.session
        from commands.views.onboarding_embeds import _processing_embed, _allowed_ack_embed, _blocked_ack_embed
